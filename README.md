...
- Incorporated limit switches to ensure repeatable homing and act as the first layer of protection from mechanical overtravel  
...
Explore how link lengths and joint limits affect the SCARA workspace:
